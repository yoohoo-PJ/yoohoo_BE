...
public interface LibraryMonthlyStatsRepository extends JpaRepository<LibraryMonthlyStats, Integer> {
    ...
    // 특정 도서관의 가장 최신 월 통계 1건만 가져옴 (개요 화면 "소장 도서 수"와 동일한 기준)
    java.util.Optional<LibraryMonthlyStats> findTopByLibraryOrderByStatYearDescStatMonthDesc(Library library);
